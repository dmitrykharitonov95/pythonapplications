...
def intersect(A1,A2,A3,A4,A5,A6):
    ...
    if (abs(val1)<eps) and (abs(val2)<eps) and (abs(val3)<eps):
        ...
        return -1
    isct=[0]*9;
    isct[0]=intersect2(A1,A2,A4,A5)
    isct[1]=intersect2(A1,A2,A4,A6)
    isct[2]=intersect2(A1,A2,A6,A5)
    isct[3]=intersect2(A1,A3,A4,A5)
    isct[4]=intersect2(A1,A3,A4,A6)
    isct[5]=intersect2(A1,A3,A6,A5)
    isct[6]=intersect2(A2,A3,A4,A5)
    isct[7]=intersect2(A2,A3,A4,A6)
    isct[8]=intersect2(A2,A3,A6,A5)
    for a in isct:
        if a>0:
            return 1
        if a==-5:
